...
//
//     final getMeasurementModel = getMeasurementModelFromJson(jsonString);

import 'dart:convert';

GetMeasurementModel getMeasurementModelFromJson(String str) =>
    GetMeasurementModel.fromJson(json.decode(str));

String getMeasurementModelToJson(GetMeasurementModel data) =>
...
class GetMeasurementModel {
  ...
  factory GetMeasurementModel.fromJson(Map<String, dynamic> json) =>
      GetMeasurementModel(
        status: json["status"],
